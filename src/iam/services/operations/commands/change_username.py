...
from iam.domain.identity.specifications import IdentifiedUserByIdentitySpec, IdentifiedUserByUsernameSpec
...
class ChangeUsernameHandler(CommandHandler[ChangeUsername, None]):
    def __init__(
        self,
