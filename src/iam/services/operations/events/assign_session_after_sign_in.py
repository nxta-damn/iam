...
from iam.services.operations.commands.sign_in import UserSignedIn
...
class AssignSessionAfterSignInHandler(EventHandler[UserSignedIn]):
    def __init__(
        self,
    ...
    def handle(self, event: UserSignedIn) -> None:
