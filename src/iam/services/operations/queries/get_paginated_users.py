...
class GetPaginatedUsers(Query[list[UserReadModel]]):
    pagination: Pagination


class GetPaginatedUsersHandler(QueryHandler[GetPaginatedUsers, list[UserReadModel]]):
    def __init__(
        self,
    ...
    async def handle(self, query: GetPaginatedUsers) -> list[UserReadModel]:
        ...
        paginated_users = await self._user_gateway.load_many(pagination=query.pagination)
