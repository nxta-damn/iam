...
class SessionGateway(ABC):
    @abstractmethod
    def with_id(self, session_id: SessionIdentity) -> SessionReadModel | None: ...
    @abstractmethod
    def with_user_id(self, user_id: UserIdentity, pagination: Pagination) -> list[SessionReadModel]: ...
